      ...
      <div className="bg-warm lg:pt-[120px] pt-20">
        <div className="container">
          <div className="flex flex-col justify-center items-center">
            ...
            <Title
              size={"3.5xl"}
              className={"max-w-[458px] mt-2.5 text-center"}
            >
              Invest in your future invest in education Where Kids
            </Title>
          </div>
              ...
              <div className="lg:max-w-[430px] w-full md:order-0 order-1">
                <SlideUp>
                  ...
                  <h4 className="text-2xl font-semibold leading-[140%]">
                    Empowering Children Through Education Igni Curiosity{" "}
                  </h4>
                </SlideUp>
                <h3 className="text-destructive-foreground lg:text-[32px] text-2xl font-bold mt-[15px]">
                  29.80$
                </h3>
                <SectionDescription className={"mt-5"}>
                  ...
                  proin metus volutpat.Lorem ipsum dolor sit amet consectetur.{" "}
                </SectionDescription>
                <div className="flex gap-8 lg:mt-10 mt-7">
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="pill"
                    className="bg-transparent text-destructive-foreground hover:text-cream-foreground hover:bg-destructive"
                  >
