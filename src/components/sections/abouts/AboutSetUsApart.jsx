...
import digitalClassroomImage from "@/assets/images/four.jpg";
...
function AboutSetUsApart() {
  ...
  const Counter = ({ endValue, label }) => {
    ...
    return (
      <div ref={counterRef} className="flex flex-col items-center text-center">
        <motion.h3 className="text-4xl font-bold text-blue-800">
  ...
  return (
    <div className="bg-white text-gray-800">
        ...
        <div className="container mx-auto grid gap-12 md:grid-cols-2 items-center">
          ...
          <AnimatedSection>
            <div className="flex flex-col items-start text-left space-y-6">
              <FaGlobe className="text-5xl text-blue-800" />
          ...
          <AnimatedSection>
            <div className="flex flex-col items-start text-left space-y-6">
              <FaAward className="text-5xl text-blue-800" />
              <h2 className="text-2xl font-bold text-blue-800">
                Award-Winning
              </h2>
              <p className="text-gray-700 leading-relaxed">
          ...
          <AnimatedSection>
            <div className="flex flex-col items-start text-left space-y-6">
              <FaChalkboardTeacher className="text-5xl text-blue-800" />
              <h2 className="text-2xl font-bold text-blue-800">
                Digital Classrooms
              </h2>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <Slider {...sliderSettings}>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="mt-4 text-blue-800 font-semibold">- Alumni</p>
            </div>
          </Slider>
        </div>
      </section>
      ...
      {/* Call to Action */}
      <section className="py-16 bg-blue-800 text-center text-white">
...
export default AboutSetUsApart;
