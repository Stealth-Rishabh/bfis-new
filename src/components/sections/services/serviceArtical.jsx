      ...
      <div className="container">
        ...
        <SlideUp delay={2}>
          <div className="lg:pt-7.5 pt-5 ">
            <h4 className="lg:text-3xl text-2xl lg:leading-[148%] leading-[130%] font-bold  font-montserrat">
              Discover the power of education Knowledge is the key
            </h4>
            <p className="lg:pt-7 pt-4">
              There are many variations passages a This category focariatio of
              deign Redefining the an the concept of living This category
              focuses on the design and construction of bu a arrangement
              ...
              {servicesDataTwo
                ...
                .map(({ icon, id, service_details, service_name }) => {
                  return (
                    <div
                      key={id}
                      className="bg-warm rounded-[10px] lg:p-7.5 p-4 "
                    >
                      <div className="bg-background rounded-[10px] p-3.5 lg:max-w-[88px] max-w-[70px] lg:max-h-[88px] max-h-[70px]">
                        <i className="text-green-foreground">
                          {renderIcon(icon)}
                        </i>
                      </div>
                      <div className="lg:mt-5 pt-3">
                        <h4 className="text-2xl font-semibold leading-[140%]">
                          {service_name}
                        </h4>
          ...
          <SlideUp delay={3}>
            <div className="max-w-[790px]">
              ...
              <p className="mt-[18px]">
                ...
                deign Redefining the an the concept of living This category
                focuses on the design and construction of bu a arrangement
                furniture and decorative elements within them focariatio of
                deign
              </p>
            </div>
          </SlideUp>
          <SlideUp delay={4}>
            <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-7.5 lg:pt-7.5 pt-5">
              <ul className="flex lg:gap-y-7.5 gap-y-5 flex-col">
                <li className="flex items-center gap-[15px] text-[#686868]">
                  <i className="text-secondary-foreground">
                    {" "}
                    <FaAnglesRight />{" "}
                  </i>{" "}
                ...
                <li className="flex items-center gap-[15px] text-[#686868]">
                  ...
                  <span>
                    Education encompasses formal learning in schools, colleges,
                    and universities
                  </span>{" "}
                </li>
                <li className="flex items-center gap-[15px] text-[#686868]">
                ...
                <li className="flex items-center gap-[15px] text-[#686868]">
                  ...
                  <span>
                    Man encompasses formal learning in schools, colleges, and
                    universities
                  </span>{" "}
                </li>
              </ul>
