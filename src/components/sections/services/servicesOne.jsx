...
import man_img from "@/assets/images/shapes/man.png"; // Retained the image
import { Button } from "@/components/ui/button";
import { FaArrowRight } from "react-icons/fa6";
import { servicesDataOne } from "@/lib/fackdata/servicesDataOne"; // Ensure the data is aligned with BFIS context
        ...
        <div className="relative after:absolute after:right-0 after:top-0 after:lg:bg-warm after:bg-transparent after:w-[calc(100%-279px)] after:h-[calc(100%-120px)] after:rounded-[10px] after:z-[-1]">
          <div className="flex lg:flex-row flex-col justify-between lg:items-center">
            ...
            <div className="flex-shrink-0 flex-grow-0 basis-auto lg:w-[50%]">
              <SectionDescription>
                At BFIS, we offer a variety of programs aimed at developing both
                academic and personal growth. Our well-rounded approach ensures
                that every student is prepared for future challenges through
              ...
              <div className="relative lg:mt-7.5 mt-5">
                ...
                <div className="lg:mt-10 mt-5">
                  ...
                  >
                    <Link to="/programs">
                      Explore Programs{" "}
                      <FaArrowRight className="text-secondary-foreground transition-all duration-300 group-hover:text-cream-foreground" />
                    </Link>
                  </Button>
                </div>
              </div>
