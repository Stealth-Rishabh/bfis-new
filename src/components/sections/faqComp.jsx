...
import { faqData } from "@/lib/fackdata/faqData"; // Ensure this data is relevant to BFIS
      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-7.5">
          <div className="max-w-[528px] lg:max-w-full mx-auto">
            <img src={faq_banner} alt="BFIS student with laptop" />
          </div>
          <div>
            <div className="lg:max-w-[520px] pb-10">
              <SectionName>Frequently Asked Questions</SectionName>
              <Title size={"3.5xl"}>
                Nurturing Students for a Brighter Future at BFIS
              </Title>
            </div>
